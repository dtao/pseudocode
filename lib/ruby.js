...
Pseudocode.Node.prototype.outputRubyEachChild = function(output) {
  this.eachChild(function(child) {
    if (typeof child.outputRuby !== 'function') {
      Pseudocode.NodeException(child + ' has no outputRuby method', child);
    }
...
Pseudocode.NodeCollection.prototype.toRubyParams = function(braces) {
  braces = braces || '()';
